...
void TestSpansAdvanced2::testSingleSpanQuery()
{
    ...
    clucene_float_t expectedScores[] = { 0.625f, 0.45927936f, 0.35355338f, 0.35355338f, 0.35355338f, 0.35355338f, 0.26516503f, };
...
void TestSpansAdvanced2::testMultipleDifferentSpanQueries()
{
    ...
    clucene_float_t expectedScores[] = { 1.0191123f, 0.93163157f };
